 ...
 * @param resolutionComment The comment that was optionally added when this alert was closed
 * @param validity The token status as of the latest validity check.
 */
@Serializable

data class OrganizationSecretScanningAlert (
    ...
    val validity: OrganizationSecretScanningAlert.Validity? = null
