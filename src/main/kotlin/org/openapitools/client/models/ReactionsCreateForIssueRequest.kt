 ...
 * 
 *
 * @param content The [reaction type](https://docs.github.com/rest/reactions/reactions#about-reactions) to add to the issue.
 */
@Serializable

data class ReactionsCreateForIssueRequest (

    /* The [reaction type](https://docs.github.com/rest/reactions/reactions#about-reactions) to add to the issue. */
    @SerialName(value = "content")
    val content: ReactionsCreateForIssueRequest.Content
