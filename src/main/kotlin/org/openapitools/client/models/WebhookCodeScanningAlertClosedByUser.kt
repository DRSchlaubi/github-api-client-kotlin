...
import org.openapitools.client.models.WebhookCodeScanningAlertClosedByUserAlert
...
data class WebhookCodeScanningAlertClosedByUser (

    @SerialName(value = "action")
    val action: WebhookCodeScanningAlertClosedByUser.Action,

    @SerialName(value = "alert")
    val alert: WebhookCodeScanningAlertClosedByUserAlert,
     ...
     * 
     *
     * Values: closed_by_user
     */
    @Serializable
    enum class Action(val value: kotlin.String) {
        @SerialName(value = "closed_by_user") closed_by_user("closed_by_user");
    }
}
