...
data class Repository6 (
    ...
    val visibility: Repository6.Visibility,
    ...
    val mergeCommitMessage: Repository6.MergeCommitMessage? = null,

    /* The default value for a merge commit title.  - `PR_TITLE` - default to the pull request's title. - `MERGE_MESSAGE` - default to the classic title for a merge message (e.g., Merge pull request #123 from branch-name). */
    @SerialName(value = "merge_commit_title")
    val mergeCommitTitle: Repository6.MergeCommitTitle? = null,
    ...
    val squashMergeCommitMessage: Repository6.SquashMergeCommitMessage? = null,

    /* The default value for a squash merge commit title. */
    @SerialName(value = "squash_merge_commit_title")
    val squashMergeCommitTitle: Repository6.SquashMergeCommitTitle? = null,
