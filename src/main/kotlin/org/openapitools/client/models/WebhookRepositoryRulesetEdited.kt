...
import org.openapitools.client.models.WebhookRepositoryRulesetEditedChanges
...
data class WebhookRepositoryRulesetEdited (

    @SerialName(value = "action")
    val action: WebhookRepositoryRulesetEdited.Action,

    @SerialName(value = "repository_ruleset")
    val repositoryRuleset: RepositoryRuleset,
    ...
    val changes: WebhookRepositoryRulesetEditedChanges? = null
