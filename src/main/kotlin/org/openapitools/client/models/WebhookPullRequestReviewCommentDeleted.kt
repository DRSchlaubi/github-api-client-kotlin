...
import org.openapitools.client.models.WebhookPullRequestReviewCommentDeletedPullRequest
...
data class WebhookPullRequestReviewCommentDeleted (

    @SerialName(value = "action")
    val action: WebhookPullRequestReviewCommentDeleted.Action,

    @SerialName(value = "comment")
    val comment: PullRequestReviewComment1,

    @SerialName(value = "pull_request")
    val pullRequest: WebhookPullRequestReviewCommentDeletedPullRequest,
