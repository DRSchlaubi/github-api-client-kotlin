...
data class IssuePerformedViaGithubApp (
    ...
    @Contextual @SerialName(value = "client_id")
    val clientId: kotlin.Any? = null,

    @Contextual @SerialName(value = "client_secret")
    val clientSecret: kotlin.Any? = null,

    @Contextual @SerialName(value = "webhook_secret")
    val webhookSecret: kotlin.Any? = null,

    @Contextual @SerialName(value = "pem")
    val pem: kotlin.Any? = null
