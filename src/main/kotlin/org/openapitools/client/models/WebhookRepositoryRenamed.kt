...
import org.openapitools.client.models.WebhookRepositoryRenamedChanges
...
data class WebhookRepositoryRenamed (

    @SerialName(value = "action")
    val action: WebhookRepositoryRenamed.Action,

    @SerialName(value = "changes")
    val changes: WebhookRepositoryRenamedChanges,
