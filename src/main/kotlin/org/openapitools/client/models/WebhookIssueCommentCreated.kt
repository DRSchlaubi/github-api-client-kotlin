...
import org.openapitools.client.models.WebhookIssueCommentCreatedIssue
...
data class WebhookIssueCommentCreated (

    @SerialName(value = "action")
    val action: WebhookIssueCommentCreated.Action,

    @SerialName(value = "comment")
    val comment: IssueComment,

    @SerialName(value = "issue")
    val issue: WebhookIssueCommentCreatedIssue,
