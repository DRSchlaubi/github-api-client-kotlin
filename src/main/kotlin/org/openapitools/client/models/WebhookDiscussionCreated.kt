...
import org.openapitools.client.models.WebhookDiscussionCreatedDiscussion
...
data class WebhookDiscussionCreated (

    @SerialName(value = "action")
    val action: WebhookDiscussionCreated.Action,

    @SerialName(value = "discussion")
    val discussion: WebhookDiscussionCreatedDiscussion,
