...
import org.openapitools.client.models.PullRequest11
...
data class WebhookPullRequestSynchronize (

    @SerialName(value = "action")
    val action: WebhookPullRequestSynchronize.Action,
    ...
    enum class Action(val value: kotlin.String) {
        @SerialName(value = "synchronize") synchronize("synchronize");
    }
}
