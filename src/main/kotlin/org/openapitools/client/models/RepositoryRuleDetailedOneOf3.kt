...
data class RepositoryRuleDetailedOneOf3 (

    @SerialName(value = "type")
    val type: RepositoryRuleDetailedOneOf3.Type?,

    /* The type of source for the ruleset that includes this rule. */
    @SerialName(value = "ruleset_source_type")
    val rulesetSourceType: RepositoryRuleDetailedOneOf3.RulesetSourceType? = null,
