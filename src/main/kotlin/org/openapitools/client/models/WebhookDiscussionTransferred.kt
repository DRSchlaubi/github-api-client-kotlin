...
import org.openapitools.client.models.WebhookDiscussionTransferredChanges
...
data class WebhookDiscussionTransferred (

    @SerialName(value = "action")
    val action: WebhookDiscussionTransferred.Action,

    @SerialName(value = "changes")
    val changes: WebhookDiscussionTransferredChanges,
