 ...
 * @param position **This parameter is deprecated. Use `line` instead**. The position in the diff where you want to add a review comment. Note this value is not the same as the line number in the file. The position value equals the number of lines down from the first \"@@\" hunk header in the file you want to add a comment. The line just below the \"@@\" line is position 1, the next line is position 2, and so on. The position in the diff continues to increase through lines of whitespace and additional hunks until the beginning of a new file.
 * @param side In a split diff view, the side of the diff that the pull request's changes appear on. Can be `LEFT` or `RIGHT`. Use `LEFT` for deletions that appear in red. Use `RIGHT` for additions that appear in green or unchanged lines that appear in white and are shown for context. For a multi-line comment, side represents whether the last line of the comment range is a deletion or addition. For more information, see \"[Diff view options](https://docs.github.com/articles/about-comparing-branches-in-pull-requests#diff-view-options)\" in the GitHub Help documentation.
 * @param line **Required unless using `subject_type:file`**. The line of the blob in the pull request diff that the comment applies to. For a multi-line comment, the last line of the range that your comment applies to.
 ...
 * @param subjectType The level at which the comment is targeted.
 */
@Serializable

data class PullsCreateReviewCommentRequest (
    ...
    val side: PullsCreateReviewCommentRequest.Side? = null,
    ...
    val startSide: PullsCreateReviewCommentRequest.StartSide? = null,
    ...
    val subjectType: PullsCreateReviewCommentRequest.SubjectType? = null
    ...
    enum class StartSide(val value: kotlin.String) {
        @SerialName(value = "LEFT") LEFT("LEFT"),
        @SerialName(value = "RIGHT") RIGHT("RIGHT"),
        @SerialName(value = "side") side("side");
    }
    /**
     * The level at which the comment is targeted.
     *
