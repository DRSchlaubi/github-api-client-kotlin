...
data class WebhookIssuesLockedIssue (

    @SerialName(value = "active_lock_reason")
    val activeLockReason: WebhookIssuesLockedIssue.ActiveLockReason?,
    ...
    val locked: WebhookIssuesLockedIssue.Locked,
    ...
    @Contextual @SerialName(value = "assignee")
    val assignee: kotlin.Any? = null,

    @SerialName(value = "draft")
    val draft: kotlin.Boolean? = null,

    @SerialName(value = "labels")
    val labels: kotlin.collections.List<@Contextual kotlin.Any>? = null,
