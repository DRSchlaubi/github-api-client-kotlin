...
import org.openapitools.client.models.WebhookMemberEditedChanges
...
data class WebhookMemberEdited (

    @SerialName(value = "action")
    val action: WebhookMemberEdited.Action,

    @SerialName(value = "changes")
    val changes: WebhookMemberEditedChanges,
