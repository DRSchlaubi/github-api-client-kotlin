...
import org.openapitools.client.models.WebhookSponsorshipPendingTierChangeChanges
...
data class WebhookSponsorshipPendingTierChange (

    @SerialName(value = "action")
    val action: WebhookSponsorshipPendingTierChange.Action,

    @SerialName(value = "changes")
    val changes: WebhookSponsorshipPendingTierChangeChanges,
     ...
     * 
     *
     * Values: pending_tier_change
     */
    @Serializable
    enum class Action(val value: kotlin.String) {
        @SerialName(value = "pending_tier_change") pending_tier_change("pending_tier_change");
    }
}
