...
import org.openapitools.client.models.WebhookIssueCommentDeletedIssue
...
data class WebhookIssueCommentDeleted (

    @SerialName(value = "action")
    val action: WebhookIssueCommentDeleted.Action,

    @SerialName(value = "comment")
    val comment: IssueComment1,

    @SerialName(value = "issue")
    val issue: WebhookIssueCommentDeletedIssue,
