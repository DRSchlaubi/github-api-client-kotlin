...
data class WebhookDependabotAlertAutoReopened (

    @SerialName(value = "action")
    val action: WebhookDependabotAlertAutoReopened.Action,
     ...
     * 
     *
     * Values: auto_reopened
     */
    @Serializable
    enum class Action(val value: kotlin.String) {
        @SerialName(value = "auto_reopened") auto_reopened("auto_reopened");
    }
}
