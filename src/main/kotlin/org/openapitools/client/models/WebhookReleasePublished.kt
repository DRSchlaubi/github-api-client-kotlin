...
import org.openapitools.client.models.WebhookReleasePublishedRelease
...
data class WebhookReleasePublished (

    @SerialName(value = "action")
    val action: WebhookReleasePublished.Action,

    @SerialName(value = "release")
    val release: WebhookReleasePublishedRelease,
