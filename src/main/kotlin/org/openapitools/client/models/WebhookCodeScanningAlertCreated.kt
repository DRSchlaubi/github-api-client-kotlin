...
import org.openapitools.client.models.WebhookCodeScanningAlertCreatedAlert
...
data class WebhookCodeScanningAlertCreated (

    @SerialName(value = "action")
    val action: WebhookCodeScanningAlertCreated.Action,

    @SerialName(value = "alert")
    val alert: WebhookCodeScanningAlertCreatedAlert,
