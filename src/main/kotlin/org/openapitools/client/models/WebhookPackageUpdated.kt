...
import org.openapitools.client.models.WebhookPackageUpdatedPackage
...
data class WebhookPackageUpdated (

    @SerialName(value = "action")
    val action: WebhookPackageUpdated.Action,

    @SerialName(value = "package")
    val `package`: WebhookPackageUpdatedPackage,
