...
import org.openapitools.client.models.WebhookSecurityAdvisoryPublishedSecurityAdvisory
...
data class WebhookSecurityAdvisoryPublished (

    @SerialName(value = "action")
    val action: WebhookSecurityAdvisoryPublished.Action,

    @SerialName(value = "security_advisory")
    val securityAdvisory: WebhookSecurityAdvisoryPublishedSecurityAdvisory,
