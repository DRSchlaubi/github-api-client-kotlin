...
import org.openapitools.client.models.WebhookCheckSuiteRequestedCheckSuite
...
data class WebhookCheckSuiteRequested (

    @SerialName(value = "action")
    val action: WebhookCheckSuiteRequested.Action,

    @SerialName(value = "check_suite")
    val checkSuite: WebhookCheckSuiteRequestedCheckSuite,
