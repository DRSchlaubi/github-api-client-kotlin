...
import org.openapitools.client.models.WebhookPullRequestReviewCommentCreatedPullRequest
...
data class WebhookPullRequestReviewCommentCreated (

    @SerialName(value = "action")
    val action: WebhookPullRequestReviewCommentCreated.Action,

    @SerialName(value = "comment")
    val comment: PullRequestReviewComment,

    @SerialName(value = "pull_request")
    val pullRequest: WebhookPullRequestReviewCommentCreatedPullRequest,
