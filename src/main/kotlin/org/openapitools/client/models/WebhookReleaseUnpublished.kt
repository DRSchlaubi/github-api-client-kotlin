...
import org.openapitools.client.models.WebhookReleaseUnpublishedRelease
...
data class WebhookReleaseUnpublished (

    @SerialName(value = "action")
    val action: WebhookReleaseUnpublished.Action,

    @SerialName(value = "release")
    val release: WebhookReleaseUnpublishedRelease,
    ...
    enum class Action(val value: kotlin.String) {
        @SerialName(value = "unpublished") unpublished("unpublished");
    }
}
