...
import org.openapitools.client.models.WebhookPullRequestReviewCommentCreatedPullRequestHead
...
data class WebhookPullRequestReviewCommentCreatedPullRequest (

    @SerialName(value = "_links")
    val links: PullRequestLinks,

    @SerialName(value = "active_lock_reason")
    val activeLockReason: WebhookPullRequestReviewCommentCreatedPullRequest.ActiveLockReason?,
    ...
    val authorAssociation: WebhookPullRequestReviewCommentCreatedPullRequest.AuthorAssociation,
    ...
    val head: WebhookPullRequestReviewCommentCreatedPullRequestHead,
    ...
    val state: WebhookPullRequestReviewCommentCreatedPullRequest.State,
