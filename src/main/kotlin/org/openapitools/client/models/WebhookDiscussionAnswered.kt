...
data class WebhookDiscussionAnswered (

    @SerialName(value = "action")
    val action: WebhookDiscussionAnswered.Action,

    @SerialName(value = "answer")
    val answer: WebhookDiscussionAnsweredAnswer,
    ...
    enum class Action(val value: kotlin.String) {
        @SerialName(value = "answered") answered("answered");
    }
}
