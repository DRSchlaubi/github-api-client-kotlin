...
import org.openapitools.client.models.WebhookCheckSuiteCompletedCheckSuite
...
data class WebhookCheckSuiteCompleted (

    @SerialName(value = "action")
    val action: WebhookCheckSuiteCompleted.Action,

    @SerialName(value = "check_suite")
    val checkSuite: WebhookCheckSuiteCompletedCheckSuite,
