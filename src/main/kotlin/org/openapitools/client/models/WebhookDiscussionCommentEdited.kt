...
import org.openapitools.client.models.WebhookDiscussionCommentCreatedComment
import org.openapitools.client.models.WebhookDiscussionCommentEditedChanges
...
data class WebhookDiscussionCommentEdited (

    @SerialName(value = "action")
    val action: WebhookDiscussionCommentEdited.Action,

    @SerialName(value = "changes")
    val changes: WebhookDiscussionCommentEditedChanges,

    @SerialName(value = "comment")
    val comment: WebhookDiscussionCommentCreatedComment,
