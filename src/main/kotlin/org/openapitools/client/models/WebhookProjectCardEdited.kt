...
import org.openapitools.client.models.WebhookProjectCardEditedChanges
...
data class WebhookProjectCardEdited (

    @SerialName(value = "action")
    val action: WebhookProjectCardEdited.Action,

    @SerialName(value = "changes")
    val changes: WebhookProjectCardEditedChanges,
