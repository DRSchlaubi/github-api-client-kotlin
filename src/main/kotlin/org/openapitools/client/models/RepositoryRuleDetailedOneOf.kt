...
data class RepositoryRuleDetailedOneOf (

    @SerialName(value = "type")
    val type: RepositoryRuleDetailedOneOf.Type?,

    /* The type of source for the ruleset that includes this rule. */
    @SerialName(value = "ruleset_source_type")
    val rulesetSourceType: RepositoryRuleDetailedOneOf.RulesetSourceType? = null,
