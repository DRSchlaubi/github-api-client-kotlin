...
data class TeamsUpdateInOrgRequest (
    ...
    val privacy: TeamsUpdateInOrgRequest.Privacy? = null,
    ...
    val notificationSetting: TeamsUpdateInOrgRequest.NotificationSetting? = null,

    /* **Deprecated**. The permission that new repositories will be added to the team with when none is specified. */
    @SerialName(value = "permission")
    val permission: TeamsUpdateInOrgRequest.Permission? = Permission.pull,
