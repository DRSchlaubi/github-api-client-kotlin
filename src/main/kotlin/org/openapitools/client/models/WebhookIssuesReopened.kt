...
import org.openapitools.client.models.WebhookIssuesReopenedIssue
...
data class WebhookIssuesReopened (

    @SerialName(value = "action")
    val action: WebhookIssuesReopened.Action,

    @SerialName(value = "issue")
    val issue: WebhookIssuesReopenedIssue,
