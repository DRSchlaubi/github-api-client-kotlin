...
data class WebhookTeamAddedToRepository (

    @SerialName(value = "action")
    val action: WebhookTeamAddedToRepository.Action,
     ...
     * 
     *
     * Values: added_to_repository
     */
    @Serializable
    enum class Action(val value: kotlin.String) {
        @SerialName(value = "added_to_repository") added_to_repository("added_to_repository");
    }
}
