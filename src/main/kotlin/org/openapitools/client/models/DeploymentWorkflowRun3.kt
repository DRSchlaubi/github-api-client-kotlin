...
data class DeploymentWorkflowRun3 (
    ...
    val conclusion: DeploymentWorkflowRun3.Conclusion?,
    ...
    val status: DeploymentWorkflowRun3.Status,
     ...
     * 
     *
     * Values: success,failure,neutral,cancelled,timed_out,action_required,stale,`null`,startup_failure
     */
    @Serializable
