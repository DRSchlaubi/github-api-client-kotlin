...
import org.openapitools.client.models.WebhookReleaseEditedChanges
...
data class WebhookReleaseEdited (

    @SerialName(value = "action")
    val action: WebhookReleaseEdited.Action,

    @SerialName(value = "changes")
    val changes: WebhookReleaseEditedChanges,
