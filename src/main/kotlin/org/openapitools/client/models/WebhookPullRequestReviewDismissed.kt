...
import org.openapitools.client.models.SimplePullRequest
import org.openapitools.client.models.SimpleUserWebhooks
import org.openapitools.client.models.WebhookPullRequestReviewDismissedReview
...
data class WebhookPullRequestReviewDismissed (

    @SerialName(value = "action")
    val action: WebhookPullRequestReviewDismissed.Action,

    @SerialName(value = "pull_request")
    val pullRequest: SimplePullRequest,

    @SerialName(value = "repository")
    val repository: RepositoryWebhooks,

    @SerialName(value = "review")
    val review: WebhookPullRequestReviewDismissedReview,
