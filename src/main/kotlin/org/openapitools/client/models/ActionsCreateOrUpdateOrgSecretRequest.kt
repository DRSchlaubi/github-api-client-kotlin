 ...
 * @param encryptedValue Value for your secret, encrypted with [LibSodium](https://libsodium.gitbook.io/doc/bindings_for_other_languages) using the public key retrieved from the [Get an organization public key](https://docs.github.com/rest/actions/secrets#get-an-organization-public-key) endpoint.
...
data class ActionsCreateOrUpdateOrgSecretRequest (

    /* Which type of organization repositories have access to the organization secret. `selected` means only the repositories specified by `selected_repository_ids` can access the secret. */
    @SerialName(value = "visibility")
    val visibility: ActionsCreateOrUpdateOrgSecretRequest.Visibility,
