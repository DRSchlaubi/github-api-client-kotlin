...
import org.openapitools.client.models.WebhookRegistryPackagePublishedRegistryPackage
...
data class WebhookRegistryPackagePublished (

    @SerialName(value = "action")
    val action: WebhookRegistryPackagePublished.Action,

    @SerialName(value = "registry_package")
    val registryPackage: WebhookRegistryPackagePublishedRegistryPackage,
