...
data class PrivateUser (
    ...
    val privateGists: kotlin.Int,

    @SerialName(value = "total_private_repos")
    val totalPrivateRepos: kotlin.Int,

    @SerialName(value = "owned_private_repos")
    val ownedPrivateRepos: kotlin.Int,

    @SerialName(value = "disk_usage")
    val diskUsage: kotlin.Int,

    @SerialName(value = "collaborators")
    val collaborators: kotlin.Int,

    @SerialName(value = "two_factor_authentication")
    val twoFactorAuthentication: kotlin.Boolean,
    ...
    @SerialName(value = "business_plus")
    val businessPlus: kotlin.Boolean? = null,
