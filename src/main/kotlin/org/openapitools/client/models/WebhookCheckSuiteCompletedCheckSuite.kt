...
data class WebhookCheckSuiteCompletedCheckSuite (
    ...
    val conclusion: WebhookCheckSuiteCompletedCheckSuite.Conclusion?,
    ...
    val status: WebhookCheckSuiteCompletedCheckSuite.Status?,
     ...
     * The summary status for all check runs that are part of the check suite. Can be `requested`, `in_progress`, or `completed`.
     *
     * Values: requested,in_progress,completed,queued,`null`,pending
     */
    @Serializable
