...
data class WebhookOrganizationMemberRemoved (

    @SerialName(value = "action")
    val action: WebhookOrganizationMemberRemoved.Action,
    ...
    enum class Action(val value: kotlin.String) {
        @SerialName(value = "member_removed") member_removed("member_removed");
    }
}
