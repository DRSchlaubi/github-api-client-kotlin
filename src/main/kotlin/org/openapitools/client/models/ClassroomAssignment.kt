 ...
 * @param studentsAreRepoAdmins Whether students are admins on created repository when a student accepts the assignment.
 * @param feedbackPullRequestsEnabled Whether feedback pull request will be created when a student accepts the assignment.
...
data class ClassroomAssignment (
    ...
    val type: ClassroomAssignment.Type,
    ...
    @SerialName(value = "starter_code_repository")
    val starterCodeRepository: SimpleClassroomRepository,
