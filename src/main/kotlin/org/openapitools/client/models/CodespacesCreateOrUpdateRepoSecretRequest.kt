 ...
 * 
 *
 * @param encryptedValue Value for your secret, encrypted with [LibSodium](https://libsodium.gitbook.io/doc/bindings_for_other_languages) using the public key retrieved from the [Get a repository public key](https://docs.github.com/rest/codespaces/repository-secrets#get-a-repository-public-key) endpoint.
 * @param keyId ID of the key you used to encrypt the secret.
 */
@Serializable

data class CodespacesCreateOrUpdateRepoSecretRequest (
