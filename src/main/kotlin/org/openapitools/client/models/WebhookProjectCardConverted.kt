...
import org.openapitools.client.models.WebhookProjectCardConvertedChanges
...
data class WebhookProjectCardConverted (

    @SerialName(value = "action")
    val action: WebhookProjectCardConverted.Action,

    @SerialName(value = "changes")
    val changes: WebhookProjectCardConvertedChanges,
