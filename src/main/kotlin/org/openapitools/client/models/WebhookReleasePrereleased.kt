...
import org.openapitools.client.models.WebhookReleasePrereleasedRelease
...
data class WebhookReleasePrereleased (

    @SerialName(value = "action")
    val action: WebhookReleasePrereleased.Action,

    @SerialName(value = "release")
    val release: WebhookReleasePrereleasedRelease,
    ...
    enum class Action(val value: kotlin.String) {
        @SerialName(value = "prereleased") prereleased("prereleased");
    }
}
