...
data class WorkflowStep1 (
    ...
    val status: WorkflowStep1.Status
     ...
     * 
     *
     * Values: failure,skipped,success,`null`,cancelled
     */
    @Serializable
     ...
     * 
     *
     * Values: in_progress,completed,queued,pending
     */
    @Serializable
