...
data class WebhookMergeGroupChecksRequested (

    @SerialName(value = "action")
    val action: WebhookMergeGroupChecksRequested.Action,
    ...
    enum class Action(val value: kotlin.String) {
        @SerialName(value = "checks_requested") checks_requested("checks_requested");
    }
}
