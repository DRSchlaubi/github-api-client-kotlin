 ...
 *
 * @param payload A URL-encoded string of the check_run.requested_action JSON payload. The decoded payload is a JSON object.
 */
@Serializable

data class WebhookCheckRunRequestedActionFormEncoded (
