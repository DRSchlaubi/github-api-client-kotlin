...
import org.openapitools.client.models.WebhookProjectsV2ItemReorderedChanges
...
data class WebhookProjectsV2ItemReordered (

    @SerialName(value = "action")
    val action: WebhookProjectsV2ItemReordered.Action,

    @SerialName(value = "changes")
    val changes: WebhookProjectsV2ItemReorderedChanges,
    ...
    enum class Action(val value: kotlin.String) {
        @SerialName(value = "reordered") reordered("reordered");
    }
}
