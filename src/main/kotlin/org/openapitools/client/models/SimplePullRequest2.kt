...
data class SimplePullRequest2 (

    @SerialName(value = "_links")
    val links: PullRequestLinks,

    @SerialName(value = "active_lock_reason")
    val activeLockReason: SimplePullRequest2.ActiveLockReason?,
    ...
    val authorAssociation: SimplePullRequest2.AuthorAssociation,
    ...
    val state: SimplePullRequest2.State,
