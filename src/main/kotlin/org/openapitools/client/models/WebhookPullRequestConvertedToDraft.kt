...
data class WebhookPullRequestConvertedToDraft (

    @SerialName(value = "action")
    val action: WebhookPullRequestConvertedToDraft.Action,
     ...
     * 
     *
     * Values: converted_to_draft
     */
    @Serializable
    enum class Action(val value: kotlin.String) {
        @SerialName(value = "converted_to_draft") converted_to_draft("converted_to_draft");
    }
}
