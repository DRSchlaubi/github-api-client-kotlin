...
import org.openapitools.client.models.PullRequest5
...
data class WebhookPullRequestLabeled (

    @SerialName(value = "action")
    val action: WebhookPullRequestLabeled.Action,
    ...
    enum class Action(val value: kotlin.String) {
        @SerialName(value = "labeled") labeled("labeled");
    }
}
