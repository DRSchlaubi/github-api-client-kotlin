 ...
 * 
 *
 * @param content The [reaction type](https://docs.github.com/rest/reactions/reactions#about-reactions) to add to the commit comment.
 */
@Serializable

data class ReactionsCreateForCommitCommentRequest (

    /* The [reaction type](https://docs.github.com/rest/reactions/reactions#about-reactions) to add to the commit comment. */
    @SerialName(value = "content")
    val content: ReactionsCreateForCommitCommentRequest.Content
