...
import org.openapitools.client.models.WebhookProjectColumnEditedChanges
...
data class WebhookProjectColumnEdited (

    @SerialName(value = "action")
    val action: WebhookProjectColumnEdited.Action,

    @SerialName(value = "changes")
    val changes: WebhookProjectColumnEditedChanges,
