...
import org.openapitools.client.models.SimplePullRequest3Head
...
data class SimplePullRequest3 (

    @SerialName(value = "_links")
    val links: PullRequestLinks,

    @SerialName(value = "active_lock_reason")
    val activeLockReason: SimplePullRequest3.ActiveLockReason?,
    ...
    val authorAssociation: SimplePullRequest3.AuthorAssociation,
    ...
    val head: SimplePullRequest3Head,
    ...
    val state: SimplePullRequest3.State,
