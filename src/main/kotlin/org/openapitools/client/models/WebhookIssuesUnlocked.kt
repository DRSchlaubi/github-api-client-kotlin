...
import org.openapitools.client.models.WebhookIssuesUnlockedIssue
...
data class WebhookIssuesUnlocked (

    @SerialName(value = "action")
    val action: WebhookIssuesUnlocked.Action,

    @SerialName(value = "issue")
    val issue: WebhookIssuesUnlockedIssue,
