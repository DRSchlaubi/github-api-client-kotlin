...
data class WebhookPullRequestReviewCommentDeletedPullRequest (

    @SerialName(value = "_links")
    val links: PullRequestLinks,

    @SerialName(value = "active_lock_reason")
    val activeLockReason: WebhookPullRequestReviewCommentDeletedPullRequest.ActiveLockReason?,
    ...
    val authorAssociation: WebhookPullRequestReviewCommentDeletedPullRequest.AuthorAssociation,
    ...
    val state: WebhookPullRequestReviewCommentDeletedPullRequest.State,
