...
import org.openapitools.client.models.WebhookIssuesMilestonedIssue
...
data class WebhookIssuesMilestoned (

    @SerialName(value = "action")
    val action: WebhookIssuesMilestoned.Action,

    @SerialName(value = "issue")
    val issue: WebhookIssuesMilestonedIssue,
