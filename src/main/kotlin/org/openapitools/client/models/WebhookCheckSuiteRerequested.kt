...
import org.openapitools.client.models.WebhookCheckSuiteRerequestedCheckSuite
...
data class WebhookCheckSuiteRerequested (

    @SerialName(value = "action")
    val action: WebhookCheckSuiteRerequested.Action,

    @SerialName(value = "check_suite")
    val checkSuite: WebhookCheckSuiteRerequestedCheckSuite,
