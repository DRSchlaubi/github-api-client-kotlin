...
import org.openapitools.client.models.WebhookCodeScanningAlertFixedAlert
...
data class WebhookCodeScanningAlertFixed (

    @SerialName(value = "action")
    val action: WebhookCodeScanningAlertFixed.Action,

    @SerialName(value = "alert")
    val alert: WebhookCodeScanningAlertFixedAlert,
