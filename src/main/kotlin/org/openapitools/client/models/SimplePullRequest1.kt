...
import org.openapitools.client.models.SimplePullRequest1Base
...
data class SimplePullRequest1 (

    @SerialName(value = "_links")
    val links: PullRequestLinks,

    @SerialName(value = "active_lock_reason")
    val activeLockReason: SimplePullRequest1.ActiveLockReason?,
    ...
    val authorAssociation: SimplePullRequest1.AuthorAssociation,

    @SerialName(value = "auto_merge")
    val autoMerge: PullRequestAutoMerge,

    @SerialName(value = "base")
    val base: SimplePullRequest1Base,
    ...
    val head: SimplePullRequest1Base,
    ...
    val state: SimplePullRequest1.State,
