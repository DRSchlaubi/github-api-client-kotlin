 ...
 * 
 *
 * @param content The [reaction type](https://docs.github.com/rest/reactions/reactions#about-reactions) to add to the team discussion.
 */
@Serializable

data class ReactionsCreateForTeamDiscussionInOrgRequest (

    /* The [reaction type](https://docs.github.com/rest/reactions/reactions#about-reactions) to add to the team discussion. */
    @SerialName(value = "content")
    val content: ReactionsCreateForTeamDiscussionInOrgRequest.Content
