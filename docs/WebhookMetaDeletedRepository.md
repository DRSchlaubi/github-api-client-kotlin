...
# WebhookMetaDeletedRepository

## Properties
Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**id** | [**kotlin.Any**](.md) | Unique identifier of the repository | 
...
**&#x60;private&#x60;** | [**kotlin.Any**](.md) | Whether the repository is private or public. | 
...
**cloneUrl** | [**kotlin.Any**](.md) |  | 
**mirrorUrl** | [**kotlin.Any**](.md) |  | 
**hooksUrl** | [**kotlin.Any**](.md) |  | 
**svnUrl** | [**kotlin.Any**](.md) |  | 
**homepage** | [**kotlin.Any**](.md) |  | 
**language** | [**kotlin.Any**](.md) |  | 
**forksCount** | [**kotlin.Any**](.md) |  | 
**stargazersCount** | [**kotlin.Any**](.md) |  | 
